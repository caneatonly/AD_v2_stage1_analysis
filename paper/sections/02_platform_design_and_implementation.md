...
## 2.1 Mission Scenario and Engineering Requirements
...
## 2.2 Realized Platform Architecture and Implementation
...
| Inner-water equivalent pitch inertia | \\(I_{water,inner}\\) | 0.01119 | kg·m² |
...
## 2.4 Deployment Procedure and Analyzed Phase Definition
...
The phase definition is aligned with the deployment procedure in Fig.~1 and provides the boundary conditions for the experimental program (Section~3), the reduced-order model (Section~4), and the validation and design analyses (Sections~6--7).

## 2.5 Coordinate Conventions and State Interface
...
## 2.6 System Boundary and Assumptions
