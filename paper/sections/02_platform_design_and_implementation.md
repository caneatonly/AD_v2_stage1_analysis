...
## 2.4 Deployment Workflow and Analyzed Phase Definition
...
The phase definition is aligned with the deployment workflow in Fig.~1 and provides the boundary conditions for the experimental program (Section~3), the reduced-order model (Section~4), and the validation and design analyses (Sections~6--7).
