...
This section documents preprocessing, segmentation, condition-level split constraints, and anti-leakage rules under \path{sim_flip/configs/id_protocol.yaml} and \path{sim_flip/configs/experiment_manifest.csv}.
