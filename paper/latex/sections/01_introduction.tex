...
\subsection{Mission Context and Engineering Motivation}
...
\subsection{Related Work and the Mission-Specific Gap}
...
\subsection{Scope, Claim Boundary, and Paper Organization}
