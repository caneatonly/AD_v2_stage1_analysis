% Converted from: paper/sections/07_parametric_analysis_and_design_guidance.md
\section{Parametric Analysis and Design Guidance}

\subsection{Purpose and Analysis Philosophy}

This section uses the validated model package to support deployment-oriented engineering decisions under bounded confidence. The goal is not to claim a globally optimal control or configuration law, but to translate the experimentally assessed model into practical guidance for the current platform architecture. All recommendations in this section are therefore conditional on the validity boundary established in Section~6 and on the configuration and evidence assumptions defined in Sections~2--3.
...
\subsection{Initial-Condition Feasibility Envelope}
...
% TODO: Insert Fig. 18 here (see paper/figures/FIGURE_REQUIREMENTS.md).

\subsection{Actuation Timing and Strategy Trade-Offs}
...
% TODO: Insert Fig. 19 here (see paper/figures/FIGURE_REQUIREMENTS.md).

\subsection{Sensitivity to Hydrostatic and Damping Uncertainty}
...
% TODO: Insert Fig. 20 here (see paper/figures/FIGURE_REQUIREMENTS.md).

\subsection{Integrated Operating Guidance for the Current Platform}
...
% TODO: Insert Fig. 21 here (see paper/figures/FIGURE_REQUIREMENTS.md).

\subsection{Scope of the Guidance and Transferability Limits}
