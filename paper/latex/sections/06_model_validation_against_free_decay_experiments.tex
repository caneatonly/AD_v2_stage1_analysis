% Converted from: paper/sections/06_model_validation_against_free_decay_experiments.md
\section{Model Validation Against Free-Decay Experiments}

\subsection{Validation Objective and Evidence Logic}
...
% TODO: Insert Fig. 13 here (see paper/figures/FIGURE_REQUIREMENTS.md).

\subsection{Simulation-to-Experiment Comparison Protocol}
...
\subsection{In-Sample Behavior and Calibration Consistency Check}
...
\subsection{Out-of-Sample Validation and Condition-Wise Performance}
...
% TODO: Insert Fig. 14--Fig. 15 here (see paper/figures/FIGURE_REQUIREMENTS.md).
...
% TODO: Add Table 2 (validation metrics by condition and split).

\subsection{GapScore Aggregation and Discrepancy-Mode Decomposition}
...
% TODO: Insert Fig. 16--Fig. 17 here (see paper/figures/FIGURE_REQUIREMENTS.md).
